...
//   const { token, login, logout, showAuth, setShowAuth } = useAuth()
...
//     onClick={logout}
//     style={{ marginLeft: '0.5rem', padding: '0.4rem 0.8rem', fontSize: '0.85rem' }}
//   >
//     Log Out
//   </button>
// ) : (
...
//     style={{ marginTop: 0, marginLeft: '0.5rem', padding: '0.4rem 0.8rem', fontSize: '0.85rem' }}
//   >
//     Log In
//   </button>
// )}
...
function AppShell({ children }) {
  ...
  onClick={async () => {
    ...
    if (isSignup) {
      ...
      if (role !== "user") {
        formData.append("admin_secret", adminPassword)
      }
